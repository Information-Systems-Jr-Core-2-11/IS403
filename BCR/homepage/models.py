...
class Organization(models.Model):
    ...
    company_description = models.CharField(max_length = 8000, blank=True)
...
class Job(models.Model):
    ...
    job_description  = models.CharField(max_length=8000, blank=True)
    job_requirements  = models.CharField(max_length=8000, blank=True)
    relocation_package  = models.CharField(max_length=8000, blank=True)
    job_benefits  = models.CharField(max_length=8000, blank=True)
...
class Applicant(models.Model):
    ...
    desired_title  = models.CharField(max_length=50, blank=True)
    city  = models.CharField(max_length=50, blank=True)
    state  = models.CharField(max_length=50, blank=True)
...
class Application_Status(models.Model):
    ...
    status_name  = models.CharField(max_length=50, blank=True)
...
class Work_Experience(models.Model):
    ...
    experience_description  = models.CharField(max_length=8000, blank=True)
    user_id = models.ForeignKey(Applicant, on_delete=models.DO_NOTHING)
